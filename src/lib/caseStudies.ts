import stallImg from "@/assets/imag1.jpg";
import thresherImg from "@/assets/image2.jpg";
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    stats: [
      {
        label: "Seed varieties held",
        value: "~300",
      },
      {
        label: "Farmers reached / year",
        value: "~200",
      },
      {
        label: "Villages served / year",
        value: "22",
      },
      {
    ...
    images: [
      {
        url: stallImg,
        caption:
          "Bibi Fathima (right) at a seed and produce stall showcasing the CSB's millet and pulse varieties.",
        imagePosition: "center",
      },
      {
        url: thresherImg,
        caption:
          "The solar-powered multi-crop thresher, with harvested millet bundles ready for processing.",
        imagePosition: "center",
      },
    ],

    sourceUrl:
      "https://docs.google.com/document/d/1CwXor1Vls0RBn8ebyAhTo_3gt9UCfQgp/edit?usp=sharing",
  },
];