...
const hi: Dict = {
  ...
  hero: {
    meta: "21-22 अगस्त 2026 · PG RESORT, नंदुरबार",
    title:
      "सामूहिक प्रयासों के माध्यम से किसानों और महिलाओं को सशक्त बनाना, नंदुरबार",
    body:
      "सेल्को फाउंडेशन और कृषि विज्ञान केंद्र, नंदुरबार द्वारा संयुक्त रूप से आयोजित — प्राथमिक उत्पादकों को क्षेत्रीय अग्रदूतों, बैंकरों और स्वच्छ ऊर्जा प्रौद्योगिकी प्रदाताओं के साथ एक मंच पर लाना।",
  },

  facts: [
    {
      title: "तिथि",
      body: "21-22 अगस्त 2026",
    },
    {
      title: "स्थान",
      body:
    ...
    },
    {
      title: "प्रतिभागी",
      body:
        "लगभग 200 किसान, एफपीओ सदस्य, एसएचजी महिला उद्यमी, बैंकर, अग्रणी उद्यमी और गैर-सरकारी संगठन",
    },
    {
    ...
    objectives: [
      {
        ...
        body:
          "स्थानीय किसानों और एसएचजी महिलाओं को क्षेत्रीय अग्रदूतों से जोड़ना ताकि स्वच्छ ऊर्जा आधारित आजीविका समाधानों को अपनाने की प्रेरणा मिले।",
      },
      {
    ...
    items: [
      {
        ...
        name: "बाजरा",
        focus:
          "प्रसंस्करण, प्राथमिक सफाई, डीस्टोनिंग और मूल्य संवर्धन।",
      },
      {
        id: "chilli",
        name: "मिर्च",
    ...
    slots: [
      {
        ...
        body:
          "माननीय जिलाधिकारी मुख्य अतिथि के रूप में, साथ में सीईओ जिला परिषद, केवीके और सेल्को फाउंडेशन के नेतृत्वकर्ता मंच पर।",
      },
      {
        time: "सुबह 10:45 – दोपहर 12:15",
        title: "क्षेत्र से सीख",
        body:
          "स्वच्छ ऊर्जा तकनीक के साथ अपने उद्यमों को बढ़ाने वाले अग्रणी किसानों और महिला उद्यमियों के अनुभव।",
      },
      {
        time: "दोपहर 12:15 – 1:00",
        title: "बैंकरों के साथ पैनल चर्चा",
        body:
          "एलडीएम और डीडीएम, नाबार्ड — ऋण पात्रता, सब्सिडी, ऋण प्रक्रिया और वित्तीय साक्षरता पर चर्चा।",
      },
      {
        time: "दोपहर 1:00 बजे से आगे",
        title:
          "भोजन, वेंडर प्रदर्शनी एवं उत्पाद प्रदर्शन",
        body:
          "नेटवर्किंग लंच के बाद पाँचों मूल्य श्रृंखलाओं में स्वच्छ ऊर्जा तकनीकों को प्रदर्शित करने वाले स्टॉल।",
      },
    ],
  },
  ...
  speakers: {
    ...
    body:
      "किसान, उद्यमी, संस्थाएँ और वित्तीय साझेदार ज्ञान साझा करने और कार्रवाई को सक्षम बनाने के लिए एक मंच पर।",
    note:
      "वक्ता, वेंडर और केस स्टडी की अधिक जानकारी उपलब्ध होते ही जोड़ी जाएगी।",
    chief: "मुख्य अतिथि",
    hosts: "प्रस्तावना",
...
const mr: Dict = {
  ...
  hero: {
    meta: "21-22 ऑगस्ट 2026 · PG RESORT, नंदुरबार",
    title:
      "सामूहिक प्रयत्नांतून शेतकरी आणि महिलांचे सक्षमीकरण, नंदुरबार",
    body:
      "सेल्को फाउंडेशन आणि कृषी विज्ञान केंद्र, नंदुरबार यांच्या संयुक्त विद्यमाने — प्राथमिक उत्पादक, क्षेत्रातील यशस्वी उद्योजक, बँकर्स आणि स्वच्छ ऊर्जा तंत्रज्ञान पुरवठादारांना एका व्यासपीठावर आणणे.",
  },

  facts: [
    {
      title: "दिनांक",
      body: "21-22 ऑगस्ट 2026",
    },
    {
      title: "ठिकाण",
      body:
    ...
    },
    {
      title: "सहभागी",
      body:
        "सुमारे 200 शेतकरी, एफपीओ सदस्य, बचत गट महिला उद्योजक, बँकर्स, यशस्वी उद्योजक आणि स्वयंसेवी संस्था",
    },
    {
      title: "मूल्य साखळ्या",
      body:
  ...
  about: {
    ...
    objectives: [
      ...
      },
      {
        ...
        body:
          "सर्व सहभागींसाठी खुल्या वेंडर प्रदर्शनातून संबंधित स्वच्छ ऊर्जा तंत्रज्ञानाचा प्रत्यक्ष अनुभव देणे.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        name: "बाजरी",
        focus:
          "प्रक्रिया, प्राथमिक स्वच्छता, दगड वेगळे करणे व मूल्यवर्धन.",
      },
      {
        id: "chilli",
        name: "मिरची",
      ...
      },
      {
        ...
        name: "मशरूम",
        focus:
          "वातावरण नियंत्रित लागवड, निर्जलीकरण व पॅकेजिंग.",
      },
      {
        id: "fisheries",
        name: "मत्स्यव्यवसाय",
        focus:
          "काढणीनंतरची हाताळणी, शीतगृह व मूल्यवर्धन.",
      },
    ],
  },
    ...
    slots: [
      {
        ...
        body:
          "मा. जिल्हाधिकारी प्रमुख पाहुणे म्हणून उपस्थित राहतील. त्यांच्यासोबत जिल्हा परिषदेचे मुख्य कार्यकारी अधिकारी, केव्हीके आणि सेल्को फाउंडेशनचे नेतृत्व मंचावर असेल.",
      },
      {
        time:
        ...
        body:
          "स्वच्छ ऊर्जा तंत्रज्ञानाच्या मदतीने आपले व्यवसाय वाढवलेल्या यशस्वी शेतकरी आणि महिला उद्योजकांचे अनुभवकथन.",
      },
      {
        time:
          "दुपारी 12:15 – 1:00",
        ...
        body:
          "एलडीएम व डीडीएम, नाबार्ड — कर्जपात्रता, अनुदान, कर्ज प्रक्रिया आणि आर्थिक साक्षरतेवर चर्चा.",
      },
      {
        time: "दुपारी 1:00 नंतर",
        title:
          "भोजन, वेंडर प्रदर्शन व उत्पादन मांडणी",
        body:
          "नेटवर्किंग भोजनानंतर पाचही मूल्य साखळ्यांतील स्वच्छ ऊर्जा तंत्रज्ञानाचे स्टॉल्स.",
      },
    ],
  },
  ...
  speakers: {
    ...
    body:
      "शेतकरी, उद्योजक, संस्था आणि वित्तीय भागीदार ज्ञानाची देवाणघेवाण आणि कृतीसाठी एका व्यासपीठावर.",
    note:
      "अधिक वक्ते, वेंडर आणि केस स्टडीची माहिती उपलब्ध होताच जोडली जाईल.",
    chief: "प्रमुख पाहुणे",
    hosts: "प्रास्ताविक",
    champions:
  ...
  gallery: {
    ...
    body:
      "मेळ्यात दाखवली जाणारी प्रत्येक तंत्रज्ञान आधीच कुटुंबांना उत्पन्न मिळवून देत आहे — पीठ आणि तेल गिरण्या, शीतगृह, शिवणकाम युनिट्स, फराळ निर्मिती आणि पूर्णतः सौरऊर्जेवर चालणारी गावे.",
    note:
...
const gu: Dict = {
  ...
  hero: {
    meta: "21-22 ઓગસ્ટ 2026 · PG RESORT, નંદુરબાર",
    title:
      "સામૂહિક પ્રયાસોથી ખેડૂતો અને મહિલાઓને સશક્ત બનાવવું, નંદુરબાર",
    body:
      "સેલ્કો ફાઉન્ડેશન અને કૃષિ વિજ્ઞાન કેન્દ્ર, નંદુરબાર દ્વારા સંયુક્ત આયોજન — પ્રાથમિક ઉત્પાદકો, ક્ષેત્રિય અગ્રણી ઉદ્યોગસાહસિકો, બેંકરો અને સ્વચ્છ ઊર્જા ટેક્નોલોજી પ્રદાતાઓને એક જ મંચ પર લાવવું.",
  },

  facts: [
    {
      title: "તારીખ",
      body: "21-22 ઓગસ્ટ 2026",
    },
    {
      title: "સ્થળ",
      body:
    ...
    },
    {
      title: "ભાગલેનારાઓ",
      body:
        "આશરે 200 ખેડૂતો, FPO સભ્યો, SHG મહિલા ઉદ્યોગસાહસિકો, બેંકરો, અગ્રણી ઉદ્યોગસાહસિકો અને NGO પ્રતિનિધિઓ",
    },
    {
      title: "મૂલ્ય શૃંખલાઓ",
      body:
    ...
    objectives: [
      {
        ...
        body:
          "સ્થાનિક ખેડૂતો અને SHG મહિલાઓને ક્ષેત્રિય અગ્રણી ઉદ્યોગસાહસિકો સાથે જોડીને સ્વચ્છ ઊર્જા આધારિત જીવનોપાર્જન ઉકેલો અપનાવવા પ્રેરિત કરવું.",
      },
      {
        title:
    ...
    items: [
      {
        ...
        name: "મિલેટ",
        focus:
          "પ્રોસેસિંગ, પ્રાથમિક સફાઈ, પથ્થર દૂર કરવા અને મૂલ્યવર્ધન.",
      },
      {
        id: "chilli",
        name: "મરચું",
      ...
      },
      {
        ...
        name: "મશરૂમ",
        focus:
          "આબોહવા નિયંત્રિત ખેતી, ડિહાઇડ્રેશન અને પેકેજિંગ.",
      },
      {
        id: "fisheries",
        name: "મત્સ્યઉદ્યોગ",
    ...
    slots: [
      {
        ...
        body:
          "માનનીય જિલ્લા કલેક્ટર મુખ્ય અતિથિ તરીકે, સાથે જિલ્લા પરિષદના CEO, કેવીકે અને સેલ્કો ફાઉન્ડેશનના નેતૃત્વ સાથે.",
      },
      {
        time:
        ...
        body:
          "સ્વચ્છ ઊર્જા ટેક્નોલોજી વડે પોતાના ઉદ્યોગો વિકસાવનાર અગ્રણી ખેડૂતો અને મહિલા ઉદ્યોગસાહસિકોના અનુભવો.",
      },
      {
        time:
          "બપોરે 12:15 – 1:00",
        ...
        body:
          "LDM અને DDM, NABARD — ધિરાણપાત્રતા, સબસિડી, લોન પ્રક્રિયા અને નાણાકીય સાક્ષરતા અંગે ચર્ચા.",
      },
      {
        time:
          "બપોરે 1:00 પછી",
        ...
        body:
          "નેટવર્કિંગ લંચ બાદ પાંચેય મૂલ્ય શૃંખલાઓની સ્વચ્છ ઊર્જા ટેક્નોલોજીના સ્ટોલ.",
      },
    ],
  },
  ...
  speakers: {
    ...
    body:
      "ખેડૂતો, ઉદ્યોગસાહસિકો, સંસ્થાઓ અને નાણાકીય ભાગીદારો જ્ઞાનની વહેંચણી અને કાર્ય માટે એક મંચ પર.",
    note:
      "વધુ વક્તાઓ, વેન્ડર અને કેસ સ્ટડીની વિગતો ઉપલબ્ધ થતાં ઉમેરવામાં આવશે.",
    chief: "મુખ્ય અતિથિ",
    hosts: "પ્રસ્તાવના",
    champions:
